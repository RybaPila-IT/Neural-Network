...
def __get_images__(file, items, item_elements):
    ...
    all_images = np.zeros(shape=(items, item_elements), dtype='uint8')
...
def show_image(image_data):
    ...
    size = (512, 512)
    proper_image = np.reshape(image_data, (28, 28))
...
if __name__ == '__main__':
    ...
    try:
        ...
        show_image(train_images[random.randrange(0, train_labels.size + 1)])
